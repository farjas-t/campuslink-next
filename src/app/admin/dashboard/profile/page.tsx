...
const breadcrumbItems = [{ title: "Dashboard", link: "/admin/dashboard/" },{ title: "Edit Profile", link: "admin/dashboard/profile" }];
export default function AdminLogin() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        try {
            ...
            const response = await fetch(`http://localhost:3500/admin/${updatedAdminId}`, {
                method: 'PATCH',
                        ...
                        <div className="mx-left flex w-full flex-col justify-start space-y-6 sm:w-[350px]">
                            ...
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 w-full">
                                    ...
                                    />
                                    <br />
                                    <Button type="submit" className="ml-auto w-full">Update</Button>
                                </form>
                            </Form>
                        </div>
                    </div>
